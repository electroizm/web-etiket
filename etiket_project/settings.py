...
# Katalog fiyat TABANI (kod kalkanÄ±). 2026-09-17'den beri satÄ±ÅŸ fiyatÄ±
# toptandan hesaplanÄ±yor (ilk fiyat Ã— bot_marj_ilk = 1,37; son fiyat Ã—
# bot_marj_son = 1,31 â€” ikisi de app_ayarlari'ndan, panelden deÄŸiÅŸir; bkz.
# catalog/services/menu_veri.satis_fiyatlari). Bu deÄŸer o merdivenin ALTINA
# konulamayacak tabandÄ±r: marj ayarlarÄ± yanlÄ±ÅŸ girilse bile hiÃ§bir teklif
# toptan Ã— 1,27'nin altÄ±na inmez. Eski 6'ya bÃ¶len merdiven formÃ¼lÃ¼ kalktÄ±.
...
# APP_SURUM = son deploy tarihi, YIL AY . GÃœN sÄ±rasÄ±yla: "YYAA.GG".
# Footer'da "v" Ã¶nekiyle gÃ¶rÃ¼nÃ¼r â†’ 2026-09-17 deploy'u "2609.17" = v2609.17.
# HER deploy Ã¶ncesi gÃ¼ncellenir. (Ä°smail 2026-09-17: sÄ±ra karÄ±ÅŸmasÄ±n â€” "1709.17"
# gibi GÃœN-AY ile baÅŸlayan damga YANLIÅ; aynÄ± gÃ¼n ikinci deploy olursa "2609.17.2".)
